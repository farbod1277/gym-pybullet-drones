...
if __name__ == "__main__":
    ...
    model = DSLPIDControlDyn(drone_model=ARGS.drone)
    ...
    for eval_step in range(0, num_eval_steps):
        ...
        for i in range(0, int(ARGS.duration_sec*env.SIM_FREQ), AGGR_PHY_STEPS):
            ...
            if i%CTRL_EVERY_N_STEPS == 0:
                ...
                action, _, _ = model.computeControlFromState(control_timestep=CTRL_EVERY_N_STEPS*env.TIMESTEP,
                                                            state=obs[0:20],
    ...
    print("Success Rate: " + str(success/num_eval_steps))