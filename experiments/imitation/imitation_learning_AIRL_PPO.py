...
if __name__ == "__main__":
    ...
    airl_logger = logger.configure(os.path.join(dirname,"./AIRL_PPO/" + str(num_trajs)))
    ...
    for i in range(n_epochs, 10000000000000, n_epochs):
        airl_logger = logger.configure(os.path.join(dirname,"./AIRL_PPO/" + str(num_trajs) + "/" + str(i)))
        airl_trainer._logger = airl_logger
        airl_trainer.train(total_timesteps=n_epochs)
        airl_trainer.gen_algo.save(os.path.join(dirname, "./AIRL_PPO/" + str(num_trajs) + "/airl_model_" + str(i) + "_on_" + str(num_trajs) + "_trajs.zip"))