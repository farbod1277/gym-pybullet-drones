...
if __name__ == "__main__":
    ...
    results = open(os.path.join(dirname, "AIRL_A2C/1000/results.csv"), 'w')
    writer = csv.writer(results, delimiter=",")

    max_model = 25952257
    for model_step in range(25952256, max_model, 245760):
        success = 0
        num_eval_steps = 1000

        if model_step > 0:
            model = sb3.A2C.load(os.path.join(dirname, "./AIRL_A2C/1000/airl_model_" + str(model_step) + "_on_1000_trajs"))
