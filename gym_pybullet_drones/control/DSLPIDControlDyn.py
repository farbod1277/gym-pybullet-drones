...
class DSLPIDControlDyn(BaseControl):
    ...
    def computeControl(self,
        ...
        -------
        ndarray
            (4,1)-shaped array of floats containing the thrus, torques x,y and z.
        ndarray
        ...
        thrust, computed_target_rpy, pos_e, scalar_thrust = self._dslPIDPositionControl(control_timestep,
                                                                         cur_pos,
                                                                         cur_quat,
                                                                         cur_vel,
                                                                         target_pos,
    ...
    def _dslPIDAttitudeControl(self,
        ...
        -------
        ndarray
            (3,1)-shaped array of floats containing the torques around x,y and z.
